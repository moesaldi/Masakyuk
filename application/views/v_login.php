                ...
                <div class="m-grid__item m-grid__item--fluid    m-login__wrapper">
                    <div class="m-login__container" style="border-radius: 40px; padding-top: 50px; background: #fff;">
                        <div class="m-login__signin">
                            ...
                            <form class="m-login__form m-form" action="<?php echo base_url('index.php/Login/proses_login'); ?>" method="post">
                                <div class="form-group m-form__group">
                                    <center><input class="form-control m-input"   type="text" placeholder="Username" name="username" autocomplete="off"></center>
                                </div>
                                <div class="form-group m-form__group">
                                ...
                                <div class="m-login__form-action">
                                    <input type="submit" name="loginuser" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air  m-login__btn" value="Sign In">
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="m-login__account">
                            ...
                            &nbsp;&nbsp;
                            <a href="<?php echo base_url('index.php/register'); ?>" class="m-link m-link--light m-login__account-link">
                                Sign Up
                            </a>
                        </div>
                    </div>
